...
namespace dae {
	...
	{
		return { Vector3{1.f,0.f,0.f}, Vector3{0.f,1.f,0.f}, Vector3{0.f,0.f,1.f}, t };
	}
	...
	Matrix Matrix::CreateRotationX(float pitch)
	{
		...
		{
			Vector3{1.f,0.f,0.f},
			Vector3{0.f, cos(pitch), -sin(pitch)},
			Vector3{0.f, sin(pitch), cos(pitch)},
			Vector3{0.f,0.f,0.f}
		};
		//assert(false && "Not Implemented Yet");
		return {m};
	...
	Matrix Matrix::CreateRotationY(float yaw)
	{
		...
		Matrix m
		{
			Vector3{cos(yaw),0.f,-sin(yaw)},
			Vector3{0.f,1.f,0.f},
			Vector3{sin(yaw), 0.f, cos(yaw)},
			Vector3{0.f,0.f,0.f}
		};
		//assert(false && "Not Implemented Yet");
		return {m};
	...
	Matrix Matrix::CreateRotationZ(float roll)
	{
		...
		Matrix m
		{
			Vector3{cos(roll),sin(roll),0.f},
			Vector3{-sin(roll), cos(roll), 0.f},
			Vector3{0.f,0.f,1.f},
			Vector3{0.f,0.f,0.f}
		};
		//assert(false && "Not Implemented Yet");
	...
	Matrix Matrix::CreateRotation(const Vector3& r)
	{
		...
		Matrix m = CreateRotationX(r.x) * CreateRotationY(r.y) * CreateRotationZ(r.z);
