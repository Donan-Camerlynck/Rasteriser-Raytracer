...
#pragma region SCENE W1
	...
	void Scene_W4_testScene::Initialize()
	{
		...
		/*pMesh->positions = { { -.75f, -1.f, .0f}, { -.75f, 1.f, .0f}, { .75f, 1.f, 1.f}, { .75f, -1.f, .0f} };
		pMesh->indices = {
			0,1,2,
			0,2,3
		};*/
	...
	void Scene_W4_ReferenceScene::Initialize()
	{
		...
		AddPointLight(Vector3{ 0.0f, 5.0f, 5.0f }, 50.f, ColorRGB{ 1.0f, 0.61f, 0.45f });
		AddPointLight(Vector3{ -2.5f, 5.0f, -5.0f }, 70.f, ColorRGB{ 1.0f, 0.8f, 0.45f });
